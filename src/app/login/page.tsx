...
const titleStyles = `text-4xl font-bold text-center mb-6 mt-6 italic ${navbarStyles["gradient-text-login"]}`
...
export default function Logn() {
  return (
    <div className='flex justify-center items-center h-screen bg-gradient-to-r from-cyan-100 to-blue-100'>
      ...
      <div className='w-1/4 min-h-64 bg-white rounded-md p-4 box-border shadow-xl flex flex-col items-center'>
